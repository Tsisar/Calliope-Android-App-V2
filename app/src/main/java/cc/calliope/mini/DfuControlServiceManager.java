...
public class DfuControlServiceManager extends BleManager {
    ...
    public static final String BROADCAST_DFU_CONTROL_SERVICE = "cc.calliope.mini.BROADCAST_DFU_CONTROL_SERVICE";
    public static final String EXTRA_DFU_CONTROL_SERVICE = "cc.calliope.mini.EXTRA_DFU_CONTROL_SERVICE";
